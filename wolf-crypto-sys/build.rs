...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg("-DWOLFSSL_SHAKE128")
        .clang_arg("-DWOLFSSL_SHAKE256")
        .clang_arg("-DHAVE_SHAKE")
    ...
    build
        ...
        .define("WOLFSSL_SHAKE128", None)
        .define("WOLFSSL_SHAKE256", None)
        .define("HAVE_SHAKE", None)
